...
class InteractionPPBlock(torch.nn.Module):
    def __init__(
        ...
        self.lin_sbf1 = nn.Linear(num_spherical * num_radial,
                                  basis_emb_size,
                                  bias=False)
...
class DimeNetPlusPlusWrap(DimeNetPlusPlus):
    ...
    def forward(self, data):
        ...
        pos = frac_to_cart_coords(data.frac_coords, data.lengths, data.angles,
                                  data.num_atoms)

        out = get_pbc_distances(data.frac_coords,
                                data.edge_index,
                                data.lengths,
                                data.angles,
                                data.to_jimages,
